...
<div class="justify-content-lg-center container text-uppercase myform" style="margin-bottom: 200px">
    <h1 class="mt-2 mb-4 text-center">Editer les Services</h1>
      <form method='POST' action="<?=PATH?>/lions/?page=edit_services" class="col s12 m8 l6 offset-l3 offset-m2 form-group ">
          <p class="mb-4">Dans cet onglet, vous pouvez gérer les informations qui seront affichées dans l'onglet "Nos Services".</p>
            <!--<div class="row">
                  <div class="col-lg-12">
            ...
            <div class="row justify-content-between">
                  <input class="btn btn-primary" type='submit' name='edit_services'>
